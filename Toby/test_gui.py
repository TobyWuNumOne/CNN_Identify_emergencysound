...
#     text="Option1", value=1, variable=radio_state, command=radiobutton_used
# )
# radiobutton2 = Radiobutton(
#     text="Option2", value=2, variable=radio_state, command=radiobutton_used
# )
# radiobutton1.pack()
# radiobutton2.pack()
...
#     text="Option1", variable=checked_state1, command=checkbutton_clicked
# )
# checkbutton2 = Checkbutton(
#     text="Option2", variable=checked_state2, command=checkbutton_clicked
# )
# checkbutton1.pack()
# checkbutton2.pack()
