# -*- coding: utf-8 -*-
"""
Created on Fri Nov 25 23:43:53 2022
...
def plot_train_history(history, x_ticks_vertical=False):
    ...
    plt.plot(max_accuracy_x, max_accuracy, marker='o', markersize=3, color="#1f77b4", alpha=0.5)
    plt.plot(max_val_accuracy_x, max_val_accuracy, marker='o', markersize=3, color="orange", alpha=0.5)
